% Melakukan Preprocessing dan Segmentasi gambar aksara
...
for x = 1:Na
    ...
    %imshow(~x1)
    pause(0)
    namefile = char(strcat('C:\Users\asus\Documents\Audy_octave\Project UAS citra_195314142\','Aksara-',num2str(x),'.jpeg'));
    imwrite(~x1,namefile);
end